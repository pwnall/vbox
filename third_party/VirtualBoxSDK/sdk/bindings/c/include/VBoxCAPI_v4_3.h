...
#define IDisplay_TakeScreenShotToArray(p, aScreenId, aWidth, aHeight, aScreenDataSize, aScreenData) ((p)->lpVtbl->TakeScreenShotToArray(p, aScreenId, aWidth, aHeight, aScreenDataSize, aScreenData))
#define IDisplay_TakeScreenShotPNGToArray(p, aScreenId, aWidth, aHeight, aScreenDataSize, aScreenData) ((p)->lpVtbl->TakeScreenShotPNGToArray(p, aScreenId, aWidth, aHeight, aScreenDataSize, aScreenData))
